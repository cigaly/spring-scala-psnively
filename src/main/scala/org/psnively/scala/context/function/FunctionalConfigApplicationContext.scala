...
class FunctionalConfigApplicationContext
	...
	/**
	 * Registers a single [[org.psnively.scala.context.function.FunctionalConfiguration]]
	...
	/**
	 * Registers one or more [[org.psnively.scala.context.function.FunctionalConfiguration]]
	 * classes to be processed. Note that ``refresh()`` must be called in order for
	 * the context to fully process the given configurations.
	...
	/**
	 * Registers one or more [[org.psnively.scala.context.function.FunctionalConfiguration]]s
