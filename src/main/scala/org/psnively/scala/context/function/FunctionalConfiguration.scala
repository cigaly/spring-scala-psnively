...
trait FunctionalConfiguration extends DelayedInit {
  ...
  private final val INIT_DESTROY_FUNCTION_PROCESSOR_BEAN_NAME =
    "org.psnively.scala.beans.factory.function.internalInitDestroyFunctionProcessor"
  ...
  private def initDestroyProcessor: InitDestroyFunctionBeanPostProcessor = {
    ...
    beanFactory.getBean(INIT_DESTROY_FUNCTION_PROCESSOR_BEAN_NAME).asInstanceOf[InitDestroyFunctionBeanPostProcessor]
  }
  ...
  private[psnively] def registerBean[T](name: String,
    beanType: Class[T],
    aliases: Seq[String],
    scope: String,
    lazyInit: Boolean,
  ...
  /**
    ...
    * designing
    * [[org.psnively.scala.context.function.FunctionalConfiguration]]
    * classes to be bootstrapped by
    * [[org.psnively.scala.context.function.FunctionalConfigApplicationContext]],
