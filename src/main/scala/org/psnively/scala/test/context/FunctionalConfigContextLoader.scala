...
import org.psnively.scala.context.function.{FunctionalConfiguration, FunctionalConfigApplicationContext}
 ...
 *
 * @note Note that [[org.psnively.scala.context.function.FunctionalConfigApplicationContext]]s
