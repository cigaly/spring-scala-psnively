...
package org.psnively.scala.test.context

import org.psnively.scala.context.function.FunctionalConfiguration
...
/**
 * Annotation specifying the [[org.psnively.scala.context.function.FunctionalConfiguration]] classes that
 * should be loaded for a Spring Test [[org.springframework.context.ApplicationContext]]. Used in conjunction with
 * [[org.psnively.scala.test.context.FunctionalConfigContextLoader]].
 *
 * @param classes [[org.psnively.scala.context.function.FunctionalConfiguration]] definitions that should be
...
/**
 * Companion object for [[org.psnively.scala.test.context.FunctionalConfigurations]] annotation. Contains
...
object FunctionalConfigurations {
  ...
  /**
   * Retrieves the [[org.psnively.scala.context.function.FunctionalConfiguration]] classes definitions from the
   * test class annotated with the [[org.psnively.scala.test.context.FunctionalConfigurations]].
   *
   * @param testClass test class to be examined (annotated with the
   *                  [[org.psnively.scala.test.context.FunctionalConfigurations]]).
   * @return Sequence of [[org.psnively.scala.context.function.FunctionalConfiguration]]s extracted from the
   *         [[org.psnively.scala.test.context.FunctionalConfigurations]] annotation. Empty sequence if no
   *         functional configuration class has been provided or
   *         [[org.psnively.scala.test.context.FunctionalConfigurations]] annotation is missing.
   */
